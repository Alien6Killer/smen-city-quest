...
class WampConnection extends AbstractConnectionDecorator {
    ...
    public function __construct(ConnectionInterface $conn) {
        ...
        $this->send(json_encode(array(WAMP::MSG_WELCOME, $this->WAMP->sessionId, 1, \App\Ratchet\VERSION)));
    }
