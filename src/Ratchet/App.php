...
use App\Ratchet\Http\OriginCheck;
use App\Ratchet\Wamp\WampServerInterface;
use App\Ratchet\Server\IoServer;
use App\Ratchet\Server\FlashPolicy;
use App\Ratchet\Http\HttpServer;
use App\Ratchet\Http\Router;
use App\Ratchet\WebSocket\WsServer;
use App\Ratchet\Wamp\WampServer;
...
class App {
    ...
    /**
     * @var \App\Ratchet\Server\IoServer
     */
    public $flashServer;
