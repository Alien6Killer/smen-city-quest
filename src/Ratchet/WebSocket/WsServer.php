...
use App\Ratchet\ComponentInterface;
use App\Ratchet\ConnectionInterface;
use App\Ratchet\MessageComponentInterface as DataComponentInterface;
use App\Ratchet\Http\HttpServerInterface;
use App\Ratchet\Http\CloseResponseTrait;
...
class WsServer implements HttpServerInterface {
    ...
    /**
     * Decorated component
     * @var \App\Ratchet\ComponentInterface
     */
    private $delegate;
    ...
    /**
     * @param \App\Ratchet\WebSocket\MessageComponentInterface|\App\Ratchet\MessageComponentInterface $component Your application to run with WebSockets
    ...
    public function onOpen(ConnectionInterface $conn, RequestInterface $request = null) {
        ...
        $response = $this->handshakeNegotiator->handshake($request)->withHeader('X-Powered-By', \App\Ratchet\VERSION);
        ...
        $wsConn = new WsConnection($conn, $request->getUri());
